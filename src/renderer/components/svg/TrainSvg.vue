...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -20 400 400" :width="width" :height="height" style="max-width: 100%;">
        <defs
            id="defs4" />
        <g
            id="g5262"
            transform="matrix(1.386118,0,0,1.542038,-196.1754,-667.7566)">
            <g
                id="g2285"
                transform="translate(-597.3004,408.9739)">
                <path
                    id="path2251"
                    style="fill:rgb(64, 123, 255);fill-opacity:0.8;fill-rule:evenodd;stroke:none;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
